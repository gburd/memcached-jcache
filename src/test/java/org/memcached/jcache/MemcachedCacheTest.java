...
public class MemcachedCacheTest {
  ...
  public void testInvoke() {
    ...
    final EntryProcessor<String, Integer, Boolean> entryProcessor =
        new EntryProcessor<String, Integer, Boolean>() {
          @Override
  ...
  public void testInvokeAll() {
    ...
    final EntryProcessor<String, Integer, Void> entryProcessor1 =
        new EntryProcessor<String, Integer, Void>() {
          @Override
    ...
    final EntryProcessor<String, Integer, Void> entryProcessor2 =
        new EntryProcessor<String, Integer, Void>() {
          @Override
          public Void process(MutableEntry<String, Integer> entry, Object... arguments)
              throws EntryProcessorException {
